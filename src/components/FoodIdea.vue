...
<template>
    <div class="container mx-auto flex flex-col items-center space-y-4 p-4 bg-gray-50 rounded-xl shadow-inner max-w-md min-h-[65vh] max-sm:min-h-[70vh]">
        ...
        <div class="card-container">
            ...
            <div class="card-body m-2 md:mt-1 bg-primary rounded-2xl p-6 max-h-[130px] md:max-h-[140px]">
